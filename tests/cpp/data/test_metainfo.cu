...
TEST(MetaInfo, FromInterface) {
  ...
  MetaInfo info;
  info.SetInfo(1, "label", str.c_str());
...
TEST(MetaInfo, Group) {
  ...
  info.SetInfo(1, "group", str.c_str());
