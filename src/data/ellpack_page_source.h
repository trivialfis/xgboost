...
struct EllpackCacheInfo {
  BatchParam param;
  float cache_host_ratio{1.0};      // The size ratio the host cache vs. the device cache
  ...
  EllpackCacheInfo(BatchParam param, float h_ratio, std::int64_t max_num_device_pages,
                   float missing)
