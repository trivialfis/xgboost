...
struct GPUHistMakerTrainParamMulti
    : public XGBoostParameter<GPUHistMakerTrainParamMulti> {
  bool single_precision_histogram;
  bool deterministic_histogram;
  bool debug_synchronize;
  // declare parameters
  DMLC_DECLARE_PARAMETER(GPUHistMakerTrainParamMulti) {
...
DMLC_REGISTER_PARAMETER(GPUHistMakerTrainParamMulti);
...
class GPUHistMakerSpecialised {
 ...
 private:
  ...
  GPUHistMakerTrainParamMulti hist_maker_param_;
...
#if !defined(GTEST_TEST)
XGBOOST_REGISTER_TREE_UPDATER(GPUHistMaker, "grow_gpu_hist_multi")
